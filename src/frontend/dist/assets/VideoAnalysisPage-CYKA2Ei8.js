import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, b as cn, d as useQueryClient, e as createActor, x as Video, C as Camera, g as Skeleton } from "./index-BUSSrS1X.js";
import { B as Badge } from "./badge-tA_YrSZS.js";
import { X, B as Button } from "./button-DIJgVfI1.js";
import { P as Primitive, a as createContextScope, c as composeEventHandlers, u as useCallbackRef, g as useLayoutEffect2 } from "./index-L_N3zCbP.js";
import { P as Presence } from "./index-c1I6fEgY.js";
import { u as useComposedRefs$1, a as useActor, b as useQuery } from "./index-BsMJgQDJ.js";
import { u as useDirection, c as clamp$1, C as ChevronUp } from "./index-DRfQwiyb.js";
...
var AnalysisMode = /* @__PURE__ */ ((AnalysisMode2) => {
  AnalysisMode2["receipt"] = "receipt";
  AnalysisMode2["food"] = "food";
  AnalysisMode2["carFashion"] = "carFashion";
  AnalysisMode2["translation"] = "translation";
  AnalysisMode2["medicalReference"] = "medicalReference";
  AnalysisMode2["artLandmark"] = "artLandmark";
  AnalysisMode2["generic"] = "generic";
  AnalysisMode2["plant"] = "plant";
  AnalysisMode2["bookProduct"] = "bookProduct";
  return AnalysisMode2;
})(AnalysisMode || {});
var Variant_pending_completed_processing_failed = /* @__PURE__ */ ((Variant_pending_completed_processing_failed2) => {
  Variant_pending_completed_processing_failed2["pending"] = "pending";
  Variant_pending_completed_processing_failed2["completed"] = "completed";
  Variant_pending_completed_processing_failed2["processing"] = "processing";
  Variant_pending_completed_processing_failed2["failed"] = "failed";
  return Variant_pending_completed_processing_failed2;
...
async function extractFramesFromVideo(file, intervalSeconds, maxFrames, onProgress) {
...
async function processFrames({
  ...
  for (const frame2 of frames) {
    if (cancelRef == null ? void 0 : cancelRef.current) break;
    try {
      ...
      await updateFrameResultFn(jobId, BigInt(frame2.frameIndex), result);
      onFrameDone == null ? void 0 : onFrameDone(frame2.frameIndex, result);
    } catch {
      const emptyResult = {
      ...
      onFrameDone == null ? void 0 : onFrameDone(frame2.frameIndex, emptyResult);
    }
  }
}
function estimateFrameCount(durationSeconds, intervalSeconds, maxFrames) {
...
const MAX_FRAMES_OPTIONS = [5, 10, 20, 50];
const STEPS = ["Upload & Configure", "Processing", "Results"];
function StepIndicator({ current }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-0 mb-8", children: STEPS.map((label, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          style: {
            color: i === current ? "oklch(var(--foreground))" : "oklch(var(--muted-foreground))"
          },
          children: label
        }
      )
    ...
    i < STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          background: i < current ? "oklch(var(--primary))" : "oklch(var(--border))"
        }
      }
    )
  ] }, label)) });
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-video bg-muted overflow-hidden", children: [
          frame2.imageBase64 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: `data:image/jpeg;base64,${frame2.imageBase64}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1.5 right-1.5", children: isProcessing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 space-y-2", children: result ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-muted-foreground line-clamp-2", children: result.sceneDescription || "No description" }),
          result.objects.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1", children: [
            result.objects.slice(0, 3).map((obj) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Badge,
              {
                variant: "outline",
            ...
            result.objects.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Badge,
              {
                variant: "outline",
                className: "text-xs px-1.5 py-0 h-auto",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
                result.sceneDescription && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground mb-1 uppercase tracking-wide", children: "Scene" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body", children: result.sceneDescription })
                ] }),
                result.extractedText && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground mb-1 uppercase tracking-wide", children: "Text" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body font-mono", children: result.extractedText })
                ] }),
                result.objects.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground mb-1 uppercase tracking-wide", children: "Detected Objects" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: result.objects.map((obj) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: "flex items-center justify-between",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body truncate", children: obj.name }),
                ...
                result.webResults.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground mb-1 uppercase tracking-wide", children: "Web Results" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: result.webResults.slice(0, 2).map((wr) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      href: wr.url,
                      target: "_blank",
        ...
        ] }) : isProcessing ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
...
function PastJobsList({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-full rounded-md" }, i)) });
  }
  if (!(jobs == null ? void 0 : jobs.length)) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "text-center py-8 text-muted-foreground text-sm",
        "data-ocid": "video.past_jobs.empty_state",
        children: "No past video analyses yet."
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: jobs.map((job, i) => {
    const statusColor = job.status === Variant_pending_completed_processing_failed.completed ? "oklch(var(--success))" : job.status === Variant_pending_completed_processing_failed.processing ? "oklch(var(--primary))" : job.status === Variant_pending_completed_processing_failed.failed ? "oklch(var(--destructive))" : "oklch(var(--muted-foreground))";
    const date = new Date(
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { className: "w-5 h-5 text-muted-foreground" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "history-item-title", children: job.videoName }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "history-item-time", children: [
...
function VideoAnalysisPage() {
  ...
  const [selectedMode, setSelectedMode] = reactExports.useState(
    AnalysisMode.generic
  );
  const [frameInterval, setFrameInterval] = reactExports.useState(5);
  const [maxFrames, setMaxFrames] = reactExports.useState(10);
  const fileInputRef = reactExports.useRef(null);
  const [extractedFrames, setExtractedFrames] = reactExports.useState([]);
  const [frameResults, setFrameResults] = reactExports.useState({});
  const [processingIndex, setProcessingIndex] = reactExports.useState(-1);
  ...
  const [expandedFrames, setExpandedFrames] = reactExports.useState(/* @__PURE__ */ new Set());
  const [showPastJobs, setShowPastJobs] = reactExports.useState(false);
  ...
  const handleVideoLoaded = reactExports.useCallback(
    (e) => {
      setVideoDuration(e.currentTarget.duration);
    },
    []
  );
  const handleStartAnalysis = reactExports.useCallback(async () => {
  ...
  const handleReset = reactExports.useCallback(() => {
    ...
    setProcessingIndex(-1);
    setExtractionError(null);
    setExpandedFrames(/* @__PURE__ */ new Set());
    setStep(0);
  }, [videoPreviewUrl]);
  const handleLoadPastJob = reactExports.useCallback((job) => {
    const loaded = job.frames.map((f) => ({
    ...
    for (const f of job.frames) {
      if (f.analysisResult) {
        results[Number(f.frameIndex)] = f.analysisResult;
      }
    }
  ...
  const renderStep1 = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      className: "space-y-6",
      children: [
        !videoFile ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `border-2 border-dashed rounded-xl flex flex-col items-center justify-center gap-4 transition-smooth ${isDragging2 ? "glow-border" : ""}`,
            style: {
              borderColor: isDragging2 ? "oklch(var(--primary))" : "oklch(var(--border))",
              background: isDragging2 ? "oklch(var(--primary) / 0.05)" : "oklch(var(--card))",
              minHeight: "220px"
            },
            onDragOver: (e) => {
              e.preventDefault();
              ...
              "label",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-lg", children: "Drop a video file here" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "MP4, WebM, MOV, AVI · or click to browse" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Film, { className: "w-4 h-4 text-muted-foreground flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-medium truncate", children: videoFile.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-mono text-muted-foreground", children: [
                ...
                " MB",
                videoDuration > 0 && ` · ${Math.floor(videoDuration / 60)}:${String(
        ...
        extractionError && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-medium mb-2 text-muted-foreground uppercase tracking-wide", children: "Analysis Mode" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: MODES.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-4 space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm", children: "Frame Extraction Settings" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "label",
                {
                  ...
                  children: "Extract a frame every"
                }
              ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs font-mono text-muted-foreground mt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "1s" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "30s" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body text-muted-foreground mb-2", children: "Maximum Frames" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: MAX_FRAMES_OPTIONS.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                className: `flex-1 py-2 rounded-md text-sm font-mono font-semibold border transition-smooth ${maxFrames === n ? "glow-border" : ""}`,
                style: maxFrames === n ? {
          ...
          videoDuration > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: isExtracting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
  ...
  const progressPercent = totalFrames > 0 ? processedCount / totalFrames * 100 : 0;
  const renderStep2 = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0, x: 20 },
      animate: { opacity: 1, x: 0 },
      ...
      children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-semibold", children: [
                "Analyzing frame",
                " ",
                processingIndex >= 0 ? processingIndex + 1 : processedCount,
                " of",
                " ",
                totalFrames,
                "…"
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3", children: extractedFrames.map((frame2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          FrameCard,
          {
            frame: frame2,
            result: frameResults[frame2.frameIndex],
            isProcessing: processingIndex === frame2.frameIndex,
            isExpanded: false,
            onToggleExpand: () => {
            },
            index: i
  ...
  const renderStep3 = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0, x: 20 },
      animate: { opacity: 1, x: 0 },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-semibold text-lg", children: [
              "Analysis Complete · ",
              processedCount,
              "/",
              totalFrames,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  ...
                  "Past Jobs",
                  showPastJobs ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-3.5 h-3.5 ml-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3.5 h-3.5 ml-1" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showPastJobs && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            initial: { height: 0, opacity: 0 },
            animate: { height: "auto", opacity: 1 },
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-4 space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Clock,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm", children: "Previous Video Jobs" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-48", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PastJobsList, { onSelect: handleLoadPastJob }) })
            ] })
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: extractedFrames.map((frame2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          FrameCard,
          {
            frame: frame2,
            result: frameResults[frame2.frameIndex],
            isProcessing: false,
            isExpanded: expandedFrames.has(frame2.frameIndex),
            onToggleExpand: () => {
              setExpandedFrames((prev) => {
                const next = new Set(prev);
                if (next.has(frame2.frameIndex)) {
                  next.delete(frame2.frameIndex);
                } else {
                  next.add(frame2.frameIndex);
                }
                return next;
              });
            },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-center pt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              type: "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-4xl mx-auto px-4 py-8 space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-2xl", children: "Video Frame Analysis" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Extract and analyze frames from any video using Venice AI" })
      ] })
    ] }),
